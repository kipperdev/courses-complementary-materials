...
1. Crie uma conta no Docker Hub ([hub.docker.com](https://hub.docker.com))
...
- O frontend pode fazer requisições para o backend usando simplesmente "[http://backend:3000](http://backend:3000)"
